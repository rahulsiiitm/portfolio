...
const experiences = [
  {
    ...
    company: "Navodaya Vidyalaya",
    location: "Assam, IN",
    desc: "Selected for a 45-day intensive teaching assignment. Managed subgroups across Kamrup, Morigaon, and Nalbari, delivering computer science curriculum to 100+ students.",
  ...
  },
  {
    ...
    year: "2024",
    role: "Lead Developer",
    company: "Udbhav Hackathon",
    location: "Manipur, IN",
    desc: "Led the technical team for the official college hackathon. Built the retro-themed landing page using React and Three.js, handling 500+ registrations.",
    tech: ["React.js", "Three.js", "Team Leadership"],
    tags: ["React", "Three.js", "Management"],
  },
];
