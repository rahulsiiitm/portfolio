    ...
    <main className={`min-h-screen bg-zinc-50 text-zinc-900 pt-24 pb-20 px-4 md:px-8 lg:px-12 font-sans selection:bg-red-500 selection:text-white relative overflow-hidden ${ammonite.variable}`}>
      ...
      <div className="max-w-[1280px] mx-auto relative z-10">
        ...
        <nav className="mb-8 flex justify-between items-center border-b border-zinc-200 pb-4">
          {/* CHANGED: href="/" to href="/archive" */}
          <Link href="/archive" className="text-xs font-mono uppercase tracking-widest text-zinc-500 hover:text-red-600 transition-colors flex items-center gap-2 font-semibold">
            <ArrowLeft size={14} />
            Back to Projects
          </Link>
