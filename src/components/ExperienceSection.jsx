    ...
    >
      ...
      <div className="relative z-10 w-full max-w-5xl xl:max-w-6xl mx-auto">
        ...
        <div className={`text-center mb-8 sm:mb-10 lg:mb-12 transition-all duration-1000 ${
          ...
          ></div>
          <p
            className="text-stone-400 text-sm sm:text-base lg:text-lg max-w-md sm:max-w-lg lg:max-w-xl mx-auto transition-all duration-1000 font-['Montserrat'] px-4"
            style={{
              animationDelay: '0.8s',
              transform: isVisible ? 'translateY(0)' : 'translateY(20px)',
              opacity: isVisible ? 1 : 0
        ...
        <div className="relative w-full">
          ...
          <div className="absolute left-3 sm:left-4 lg:left-1/2 top-0 bottom-0 w-0.5 bg-zinc-700/40 rounded-full transform lg:-translate-x-1/2 z-0"></div>
            ...
            {experiences.map((exp, index) => (
              ...
              >
                ...
                <div className={`w-full lg:w-5/12 ml-6 sm:ml-8 lg:ml-0 ${
                  ...
                  <div className="bg-black/[0.1] backdrop-blur-sm border border-white/[0.08] rounded-lg sm:rounded-xl lg:rounded-2xl p-4 sm:p-5 lg:p-6 hover:bg-white/[0.06] hover:border-white/[0.15] transition-all duration-500 group">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-3 sm:mb-4">
                        <div className="flex flex-col mb-2 sm:mb-0">
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center text-stone-300 mt-1 font-['Montserrat'] text-xs sm:text-sm">
                                <span className="font-medium">{exp.company}</span>
                                <span className="hidden sm:inline mx-2 text-stone-500">•</span>
                                <span className="text-stone-400 sm:mt-0">{exp.location}</span>
                            </div>
                        </div>
                        <span className="text-stone-400 text-xs bg-zinc-800/40 px-2 sm:px-3 py-1 sm:py-1.5 rounded-full font-medium font-['Montserrat'] whitespace-nowrap">
                            {exp.period}
                        </span>
                    </div>

                    {/* Description - Responsive text */}
                    <p className="text-stone-400 leading-relaxed mb-4 sm:mb-5 group-hover:text-stone-300 transition-colors duration-300 font-['Montserrat'] text-xs sm:text-sm">
                      {exp.description}
                    </p>
                    ...
                    <div className="space-y-3 sm:space-y-4">
                        {/* Key Achievements */}
                        <div>
                            <h4 className="text-stone-300 font-medium mb-2 group-hover:text-white transition-colors duration-300 text-xs sm:text-sm font-['Lufga']">
                                Key Achievements
                            </h4>
                            <ul className="space-y-1 sm:space-y-1.5 font-['Montserrat']">
                                {exp.achievements.map((achievement, achIndex) => (
                                    <li key={achIndex} className="text-stone-400 text-xs flex items-start group-hover:text-stone-300 transition-colors duration-300 leading-relaxed">
                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap gap-1 sm:gap-1.5 font-['Montserrat']">
                                {exp.technologies.map((tech, techIndex) => (
                                    <span key={techIndex} className="px-2 sm:px-2.5 py-1 bg-zinc-800/40 border border-[#FF4500]/20 rounded-full text-xs text-stone-300 hover:border-[#FF4500]/50 hover:text-[#FF4500] hover:bg-zinc-800/60 transition-all duration-300 cursor-default font-medium">
                                        {tech}
                                    </span>
                                ))}
                            </div>
